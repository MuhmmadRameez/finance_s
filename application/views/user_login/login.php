...
<div class="col-md-12">
<h3 class="text-center txt-primary"><i class="fa fa-key text-primary"></i></h3>
</div>
</div>

<p class="text-muted text-center p-b-5">Sign in with your regular account</p>
<div class="form-group form-primary">
<input type="text" name="email" placeholder="Enter Your Email Adress" class="form-control" required="">
...
<p class="text-inverse text-left">Don't have an account?<a href="<?= site_url('Signup/') ?>"> <b>Register here </b></a>for free!</p>
</div>
</div>
</form>
