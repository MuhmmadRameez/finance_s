   ...
   <body themebg-pattern="theme1">
      ...
      <section class="login-block">
         <div class="container-fluid">
            ...
            <p class="text-center">Confirm Your Number</p>
            <div class="row">
               <div class="col-sm-12">
                  <form method="post" action="<?= site_url('Login/number_check') ?>">
                     ...
                     <div class="auth-box card">
                        <div class="card-block">
                           ...
                           <div class="form-group form-primary">
                              ...
                              <input type="text" name="number" placeholder="Enter Number" class="form-control" required="">
                              <span class="form-bar"></span>
                           </div>
                           <div class="row">
                              <div class="col-md-12">
                                 <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20"><i class="icofont icofont-user"></i>Send Message </button>
                              </div>
                           </div>
