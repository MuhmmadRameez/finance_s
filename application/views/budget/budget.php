...
<script>
   $(document).ready(function() {
       ...
       var myLineChart = new Chart(ctx, {
           type: 'pie',
           data: {
               labels: ["paycheck", "additional_income", "Utilities", "Dining Traveling entertainment","Education"],
               datasets: [{
                   data: [<?= $fetch_money_out['groceries'] ?>, <?= $fetch_money_out['transpotation'] ?>, <?= $fetch_money_out['utilities'] ?>, <?= $fetch_money_out['dining_traveling'] ?>,<?= $fetch_money_out['education'] ?>,],
...
<script>
   $(document).ready(function() {
       ...
       var myLineChart = new Chart(ctx, {
           type: 'pie',
           data: {
               labels: ["Paycheck", "Additional Income"],
               datasets: [{
                   data: [<?= $money_in['paycheck'] ?>,<?= $money_in['additional_income'] ?>,],
                   backgroundColor: ["rgba(255, 0, 0, 0.5)", "rgba(100, 255, 0, 0.5)", "rgba(200, 50, 255, 0.5)", "rgba(0, 100, 255, 0.5)"]
               }]
           },
           options: {
            ...
            <div class="page-body">
              <div class="row ">
                  <div class="col-md-6 col-lg-6">
                     <div class="card">
                        <div class="card-header text-success" style="font-weight: 900;text-align: center">Money In</div>
                    ...
                    <div class="col-md-6 col-lg-6">
                                       <div class="card ticket-card" style="border:1px solid gray;">
                                          <div class="card-body">
                                            <table style="width: 100%">
                                               <tr>
                                                  <th>Paycheck</th>
                                                  <th>US $<?= $money_in['paycheck'] ?></th>
                                               </tr>

                                                <tr>
                                                  <th>Additional Amount</th>
                                                  <th>US $<?= $money_in['additional_income'] ?></th>
                                               </tr>
                                               <tr>
                                                  <th style="font-weight: 900;">Total Expense</th>
                                                  <th style="font-weight: 900;">US $<?= $money_in['paycheck'] + $money_in['additional_income']?></th>
                                               </tr>
                                            </table>
                                          </div>
                                       </div>
                                       <a href="<?= site_url('Budget/money_in/') ?>" class="btn btn-primary col-md-4" style="border-radius: 50px;background-image: linear-gradient(to right, #26b0d1 , #3b62ab);">Add Record <i class="fa fa-plus"></i></a>
                                    </div>
               </div>
               <div class="row ">
                  <div class="col-md-6 col-md-6">
                     <div class="card">
                        <div class="card-header text-danger" style="font-weight: 900; text-align: center">Money Out</div>
                        <div class="card-body" style="height: auto">
                           <div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;">
                              <div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;">
                                 <div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div>
                           ...
                           <canvas id="money_out" width="299" height="250" class="chartjs-render-monitor" style="display: block; width: 299px; height: 200px;"></canvas>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-6 col-md-6 mt-10">
                     <div class="card ticket-card" style="border:1px solid gray;">
                        <div class="card-body">
                           <table style="width: 100%">
                              <tr>
                                 <th>Groceries</th>
                                 <th>US$ <?= $fetch_money_out['groceries'] ?></th>
                              </tr>
                              <tr>
                                 <th>Transpotation</th>
                                 <th>US $<?= $fetch_money_out['transpotation'] ?> </th>
                              </tr>
                              <tr>
                                 <th>Utilities</th>
                                 <th>US$ <?= $fetch_money_out['utilities'] ?></th>
                              </tr>
                              <tr>
                                 <th>Dining,Traveling,entertainment</th>
                                 <th>US$ <?= $fetch_money_out['dining_traveling'] ?></th>
                              </tr>
                              <tr>
                                 <th>Education</th>
                                 <th>US $<?= $fetch_money_out['education'] ?></th>
                              </tr>
                              <tr>
                                 <th style="font-weight: 900;">Total Expense</th>
                                 <th style="font-weight: 900;">US $ <?= $fetch_money_out['groceries'] +$fetch_money_out['transpotation']+$fetch_money_out['utilities'] +$fetch_money_out['dining_traveling']+ $fetch_money_out['education'] ?></th>
                              </tr>
                           </table>
                        </div>
                     </div>
                     <a href="<?= site_url('Budget/money_out/') ?>" class="btn btn-primary col-md-4" style="border-radius: 50px;background-image: linear-gradient(to right, #26b0d1 , #3b62ab);">Add Record <i class="fa fa-plus"></i></a>
                  </div>
               </div>
               <div class="row ">
