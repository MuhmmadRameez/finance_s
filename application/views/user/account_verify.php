   ...
   <body themebg-pattern="theme1">
      ...
      <section class="login-block">
         <div class="container-fluid">
            <h1 align="center">Welcome To Finance System</h1>
            <p align="center">We have sent you a 4 digit Passcode on your registered</p>
            <div class="row">
               <div class="col-sm-12">
                  <form method="post" action="<?= site_url("User/number_verification") ?>">
                     <div class="text-center">
                           <h4 class="text-dark text-center"><b>Finance System</b></h4>
                     </div>
