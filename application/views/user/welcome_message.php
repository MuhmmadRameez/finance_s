   ...
   <body themebg-pattern="theme1">
      ...
      <section class="login-block">
         <div class="container-fluid">
            <div class="row">
               <div class="col-sm-12">
                  <h1  align="center" class="text-success"><i class="fa fa-check"></i></h1>
                  <h4 align="center">Your Account Verify Successfully</h4>
                 <p align="center"><a href="<?= site_url("Login/") ?>">Login</a></p>
               </div>
            </div>
         </div>
      </section>
